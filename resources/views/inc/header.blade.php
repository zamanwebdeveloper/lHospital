...
<title>:: Digital - Hospital Admin ::</title>
...
<ul id="f-menu" class="mfbc-br mfb-zoomin" data-mfb-toggle="hover">
    <li class="mfbc_wrap">
        ...
        <ul class="mfbc_list">
            ...
            <li><a href="{{url('/payments')}}" data-mfb-label="Payments" class="mfb-child bg-purple"><i class="zmdi zmdi-balance-wallet mfbc_icon"></i></a></li>
        </ul>
    </li>
</ul>
...
<div id="morphsearch" class="morphsearch">
    <form class="morphsearch-form">
        <div class="form-group m-0">
            <input value="" type="search" placeholder="Explore Fast..." class="form-control morphsearch-input" />
...
<nav class="navbar clearHeader">
    <div class="col-12">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand" href="{{url('/')}}">Digital Hospital</a> </div>
            ...
            <ul class="list">
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-balance-wallet"></i><span>Payments</span> </a>
                    <ul class="ml-menu">
                        ...
                        <li> <a href="{{url('/add-payments')}}">Add Payment</a></li>
                        <li> <a href="{{url('/patient-invoice')}}">Patient Invoice</a></li>
                    </ul>
                </li>
